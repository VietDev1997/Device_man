                                ...
                                <div class="login">
						    	    ...
						    	    <span class="error" id="browser_warning" style="display:none">
						    	        ...
						    	        {sugar_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
                                            ...
                                            {/if}
                                            <tr>
                                                <td scope="row" width="30%"><label for="user_name"><i class="glyphicon glyphicon-user"></i>  {sugar_translate module="Users" label="LBL_USER_NAME"}:</label></td>
                                                <td width="70%"><input type="text" size='35' tabindex="1" id="user_name" name="user_name"  value='{$LOGIN_USER_NAME}' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td scope="row"><label for="user_password"><i class="glyphicon glyphicon-lock"></i>  {sugar_translate module="Users" label="LBL_PASSWORD"}:</label></td>
                                ...
                                <td colspan="2" class="login_more">
                                    ...
                                    <div id="forgot_password_dialog" style="display:none" >
                                        ...
                                        <table cellpadding="0" cellspacing="2" border="0" align="center" width="100%" >
                                            ...
                                            <tr>
                                                <td scope="row" width="30%"><label for="fp_user_name"><i class="glyphicon glyphicon-user"></i>  {sugar_translate module="Users" label="LBL_USER_NAME"}:</label></td>
                                                <td width="70%"><input type="text" size='26' id="fp_user_name" name="fp_user_name"  value='{$LOGIN_USER_NAME}' /></td>
                                            </tr>
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td scope="row" width="30%"><label for="fp_user_mail"><i class="glyphicon glyphicon-envelope"></i>  {sugar_translate module="Users" label="LBL_EMAIL"}:</label></td>
