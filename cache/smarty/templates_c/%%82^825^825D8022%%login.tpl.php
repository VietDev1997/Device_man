<?php /* Smarty version 2.6.29, created on 2018-08-13 05:08:25
         compiled from custom/include/login/tpls/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'custom/include/login/tpls/login.tpl', 42, false),array('function', 'sugar_getimagepath', 'custom/include/login/tpls/login.tpl', 143, false),)), $this); ?>
<!--
/*********************************************************************************
...
<table cellpadding="0" align="center" width="100%" cellspacing="0" border="0" style="height: 600px">
    <tr>
        <td align="center">
            <div class="loginBoxShadow" style="width: 460px;">
                <div class="loginBox" style="border: none;width: 100%;background-color: #cadeec;border-radius: 10px">
                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                        <tr>
                            <td align="center">
                                <img alt="" src="https://jobseekers.vn/wp-content/uploads/2017/08/V-Next_Logo.png" width="184px">
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
...
:</td>
                                            ...
                                            <?php endif; ?>
                                            <tr>
                                                <td scope="row" width="30%"><label for="user_name"><i class="glyphicon glyphicon-user"></i>  <?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_USER_NAME'), $this);?>
:</label></td>
...
' /></td>
                                            ...
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td scope="row"><label for="user_password"><i class="glyphicon glyphicon-lock"></i>  <?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_PASSWORD'), $this);?>
:</label></td>
...
"><br>&nbsp;</td>
    ...
    <br>
                <div class="password" style="background-color: #cadeec">
...
" border="0" alt="Hide Options" id="forgot_password_dialog_options"><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_FORGOT_PASSWORD'), $this);?>
                                    ...
                                    <div id="forgot_password_dialog" style="display:none" >
                                        ...
                                        <table cellpadding="0" cellspacing="2" border="0" align="center" width="100%" >
                                            ...
                                            <tr>
                                                <td scope="row" width="30%"><label for="fp_user_name"><i class="glyphicon glyphicon-user"></i>  <?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_USER_NAME'), $this);?>
:</label></td>
...
' /></td>
                                            ...
                                            <tr><td><br></td></tr>
                                            <tr>
                                                <td scope="row" width="30%"><label for="fp_user_mail"><i class="glyphicon glyphicon-envelope"></i>  <?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_EMAIL'), $this);?>
:</label></td>
