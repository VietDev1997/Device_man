<?php /* Smarty version 2.6.29, created on 2018-08-13 05:34:41
         compiled from cache/themes/SuiteR/modules/devic_device/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 57, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 44, false),array('function', 'counter', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 56, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/devic_device/EditView.tpl', 328, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=devic_device'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['code']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['code']['name']; ?>
' size='30' 
maxlength='255' 
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['status']['name']; ?>
' 
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['monitor']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['monitor']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['keyboard']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['keyboard']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['mouse']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['mouse']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['case_device']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['case_device']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['config']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['config']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QUANTYTI','module' => 'devic_device'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<?php if (strlen ( $this->_tpl_vars['fields']['quantyti']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['quantyti']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['quantyti']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['quantyti']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['quantyti']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['history']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['history']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1cate_category_device_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"cate_category_device_devic_device_1cate_category_device_ida","name":"cate_category_device_devic_device_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['cate_category_device_devic_device_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['users_devic_device_1users_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"users_devic_device_1users_ida","name":"users_devic_device_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_USERS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['users_devic_device_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='date_entered_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'devic_device'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'code\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CODE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'status\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'monitor\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MONITOR','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'keyboard\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_KEYBOARD','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'mouse\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MOUSE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'case_device\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CASE_DEVICE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'config\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONFIG','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'quantyti\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_QUANTYTI','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'price\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRICE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'history\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_HISTORY','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'devic_device_repor_user_report_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEVIC_DEVICE_REPOR_USER_REPORT_1_FROM_REPOR_USER_REPORT_TITLE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'cate_category_device_devic_device_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATE_CATEGORY_DEVICE_DEVIC_DEVICE_1_FROM_CATE_CATEGORY_DEVICE_TITLE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'users_devic_device_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_USERS_DEVIC_DEVICE_1_FROM_USERS_TITLE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'devic_device','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'EditView\', \'cate_category_device_devic_device_1_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'devic_device','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATE_CATEGORY_DEVICE_DEVIC_DEVICE_1_FROM_CATE_CATEGORY_DEVICE_TITLE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\', \'cate_category_device_devic_device_1cate_category_device_ida\' );
addToValidateBinaryDependency(\'EditView\', \'users_devic_device_1_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'devic_device','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_USERS_DEVIC_DEVICE_1_FROM_USERS_TITLE','module' => 'devic_device','for_js' => true), $this);?>
<?php echo '\', \'users_devic_device_1users_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_cate_category_device_devic_device_1_name\']={"form":"EditView","method":"query","modules":["cate_category_device"],"group":"or","field_list":["name","id"],"populate_list":["cate_category_device_devic_device_1_name","cate_category_device_devic_device_1cate_category_device_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_users_devic_device_1_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["users_devic_device_1_name","users_devic_device_1users_ida"],"required_list":["users_devic_device_1users_ida"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
